...
export const generateVerificationToken = async (email: string) => {
    ...
    const verificationToken = new VerificationToken({ email, token, expires });
...
export const generatePasswordResetToken = async (email: string) => {
    ...
    const passwordResetToken = new PasswordResetToken({ email, token, expires });
...
export const generateTwoFactorToken = async (email: string) => {
    ...
    const twoFactorToken = new TwoFactorToken({ email, token, expires });
