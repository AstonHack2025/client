...
const Badge: React.FC<BadgeProps> = ({ color, icon, stars }) => {
    const gradientId = useId();
    const { theme } = useTheme();

    return (
        <div className="relative inline-block">
            <div className="w-24 h-28 flex flex-col items-center justify-center p-2 relative">
                <svg width="100" height="100" viewBox="0 0 91 100" xmlns="http://www.w3.org/2000/svg" className="mx-auto absolute">
                    <defs>
                        <linearGradient id={`badge-gradient-${gradientId}`} x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <div className="absolute flex flex-col items-center">
                    <div className="text-black text-bold scale-[auto] text-center">{icon}</div>
