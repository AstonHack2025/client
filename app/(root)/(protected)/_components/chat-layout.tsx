...
export default function ChatLayout(data: any, roomId: string) {
    ...
    return (
        <div className="h-[90%] flex">
            <div className="w-64 bg-gray-100 dark:bg-gray-800 p-4 border-r flex flex-col h-full shadow-md dark:border-gray-700">
                {/* Users section */}
                <div>
                    <h2 className="text-lg font-bold mb-2 text-black dark:text-white">Users in Chat</h2>
                ...
                <div className="space-y-2">
                    <Button className="w-full flex justify-center space-x-1" onClick={() => setActiveView("chat")}>
                        <p>Open Chat</p>
                    ...
                    <Button className="w-full flex justify-center space-x-1" onClick={() => setActiveView("whiteboard")}>
                        <p>Open Whiteboard</p>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                            <path
                                strokeLinecap="round"
                    ...
                    <Button className="w-full flex justify-center space-x-1" onClick={() => window.open(`http://localhost:3000/room?roomId=${roomId}`,)}>
                ...
                <div className="flex-1 flex flex-col">
                        ...
                        {messages.map((message) => (
                            <div key={message.id}>
                                ...
                                <div className="dark:bg-gray-800 dark:text-white rounded p-2 shadow-sm max-w-[100%]">
                                    ...
                                    {message.attachment && (
                                        <div className="mt-2">
                                            <a href={message.attachment.fileUrl} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
                    ...
                    <div className="border-t bg-white dark:bg-gray-800 p-4">
                        <div className="flex">
                            ...
                            <Button className="rounded-full shadow" onClick={handleSend} variant="default">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" />
                                </svg>
                            </Button>
                        </div>
                        {selectedFile && <div className="mt-2 text-sm text-gray-400">Attached: {selectedFile.name}</div>}
                    </div>
                </div>
            )}
        </div>
