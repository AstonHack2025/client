...
export const NewPasswordForm = () => {
    ...
    return (
        <FormWrapper headerLabel="Enter a new password" backButtonLabel="Back to sign in" backButtonHref="/signin">
            <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={isPending} type="password" placeholder="confirm password" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
